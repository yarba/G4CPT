...
# svn keywords:
# $Rev: 422 $: Revision of last commit
# $Author: genser $: Author of last commit
# $Date: 2010-02-04 14:26:41 -0600 (Thu, 04 Feb 2010) $: Date of last commit
...
sed -i_orig7 "s/^g4granular='y'/g4granular='n'/" Configure
sed -i_orig8 "s/^g4debug=''/g4debug='y'/" Configure
sed -i_orig9 "s/^g4debug='n'/g4debug='y'/" Configure
