...
int cpu_cores_cmsExpTasking_elec_E5()
{
   gROOT->Reset();
...
//   int beam[nb] = {0,1,2,4,6,8,10,12};
   ...
   c2->cd();
   TPostScript *ps2 = new TPostScript("cpu_cores_cmsExpTasking_elec_E5.eps",113);
...
// -->   TLine* llow = new TLine(0.7, 1.0, 15, 1.0);
   ...
   */
   ...
   char pngtitle[256];   
   sprintf(pngtitle,"cpu_cores_cmsExpTasking_elec_E5.%s","png");
