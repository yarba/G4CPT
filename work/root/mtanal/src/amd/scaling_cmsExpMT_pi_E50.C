...
//   int beam[nb] = {0,1,2,4,8,16,24,32};
   ...
   c2->cd();
   TPostScript *ps2 = new TPostScript("scaling_cmsExpMT_pi_E50.eps",113);
   ...
   hhf3 = new TH2F("hhf3","1024 events with 50 GeV #pi^{-}", 1,0.7,40.,1,50.0,30000.);
   ...
   */
   ...
   char pngtitle[256];   
   sprintf(pngtitle,"scaling_cmsExpMT_pi_E50.%s","png");
