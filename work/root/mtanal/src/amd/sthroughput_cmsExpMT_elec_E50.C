...
int sthroughput_cmsExpMT_elec_E50()
{
   gROOT->Reset();
   ...
   for(int i = 0 ; i < nb ; i++) {
     sprintf(gffilename,"./scaling_e-_E50_t%d.sdat",beam[i]);
   ...
   c2->cd();
   TPostScript *ps2 = new TPostScript("sthroughput_cmsExpMT_elec_E50.eps",113);
   ...
   hhf3 = new TH2F("hhf3","Event Throughput - 50 GeV e^{-}", 1,0.7,40.,1,0.2,20.);
   ...
   char pngtitle[256];   
   sprintf(pngtitle,"sthroughput_cmsExpMT_elec_E50.%s","png");
