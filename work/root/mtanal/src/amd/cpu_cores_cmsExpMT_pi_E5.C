...
//   int beam[nb] = {0,1,2,4,8,16,24,32};
   ...
   c2->cd();
   TPostScript *ps2 = new TPostScript("cpu_cores_cmsExpMT_pi_E5.eps",113);
   ...
   hhf3 = new TH2F("hhf3","Speedup Efficiency - 5 GeV #pi^{-}", 1,0.7,40.,1,0.8,1.1499);
   ...
   */
   ...
   char pngtitle[256];   
   sprintf(pngtitle,"cpu_cores_cmsExpMT_pi_E5.%s","png");
