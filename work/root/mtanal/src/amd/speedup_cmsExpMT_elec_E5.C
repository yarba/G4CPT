...
int speedup_cmsExpMT_elec_E5()
{
   ...
   c2->cd();
   TPostScript *ps2 = new TPostScript("speedup_cmsExpMT_e_E5.eps",113);
   ...
   hhf3 = new TH2F("hhf3","Performance with 5 GeV e^{-}", 1,0.7,40.,1,0.5,50.);
   ...
   char pngtitle[256];   
   sprintf(pngtitle,"speedup_cmsExpMT_elec_E5.%s","png");
