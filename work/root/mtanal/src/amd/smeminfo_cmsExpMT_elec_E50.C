...
int smeminfo_cmsExpMT_elec_E50()
{
   gROOT->Reset();
   ...
   for(int i = 0 ; i < nb ; i++) {
     sprintf(gffilename,"./meminfo_e-_E50_t%d.sdat",beam[i]);
   ...
   c2->cd();
   TPostScript *ps2 = new TPostScript("smeminfo_cmsExpMT_elec_E50.eps",113);
   ...
   hhf3 = new TH2F("hhf3","Memory (RSS-SHARED) - 50 GeV e^{-}", 1,0.7,40.,1,99.99,20000.);
   ...
   */
   ...
   char pngtitle[256];   
   sprintf(pngtitle,"smeminfo_cmsExpMT_elec_E50.%s","png");
