...
//   int beam[nb] = {0,1,2,4,8,16,24,32};
   ...
   c2->cd();
   TPostScript *ps2 = new TPostScript("scaling_cmsExpMT_pi_E5.eps",113);
   ...
   hhf3 = new TH2F("hhf3","1024 events with 5 GeV #pi^{-}", 1,0.7,40.,1,5.0,3000.);
   ...
   */
   ...
   char pngtitle[256];   
   sprintf(pngtitle,"scaling_cmsExpMT_pi_E5.%s","png");
