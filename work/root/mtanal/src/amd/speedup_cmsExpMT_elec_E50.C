...
//   int beam[nb] = {0,1,2,4,8,16,24,32};
   ...
   c2->cd();
   TPostScript *ps2 = new TPostScript("speedup_cmsExpMT_elec_E50.eps",113);
   ...
   hhf3 = new TH2F("hhf3","Performance with 50 GeV e^{-}", 1,0.7,40.,1,0.5,50.);
   ...
   char pngtitle[256];   
   sprintf(pngtitle,"speedup_cmsExpMT_elec_E50.%s","png");
