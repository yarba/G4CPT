...
//   int beam[nb] = {0,1,2,4,8,16,24,32};
   ...
   for(int i = 0 ; i < nb ; i++) {
     sprintf(gffilename,"./meminfo_pi-_E5_t%d.sdat",beam[i]);
   ...
   c2->cd();
   TPostScript *ps2 = new TPostScript("smeminfo_cmsExpMT_pi_E5.eps",113);
   ...
   hhf3 = new TH2F("hhf3","Memory (RSS-SHARED) - 5 GeV #pi^{-}", 1,0.7,40.,1,99.99,15000.);
   ...
   */
   ...
   char pngtitle[256];   
   sprintf(pngtitle,"smeminfo_cmsExpMT_pi_E5.%s","png");
