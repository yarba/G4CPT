...
G4P_SQL_DIR=${G4P_CGI_DIR}/g4p_${GEANT4_VERSION}_${APPLICATION_NAME}_${EXP_NUM}
G4P_ROOT_DIR=/g4/g4p/work/root/igprof
MEM_TEMPLATE=/g4/g4p/work/analysis/src/template_mem_summary.html
...
for event_at in ${event_list}; do
  data_file="mem_summary_${GEANT4_VERSION}_${APPLICATION_NAME}.data.${event_at}"
