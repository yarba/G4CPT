...
# --> migrate again --> CPU_SUMMARY_1=/lfstev/g4p/g4p/work/root/sprof/cpu_summary_${xver1}_${xapp}.data
# --> migrate again --> CPU_SUMMARY_2=/lfstev/g4p/g4p/work/root/sprof/cpu_summary_${xver2}_${xapp}.data
#
# --> Jan.2021 migration to WC-IC
#
CPU_SUMMARY_1=/work1/g4p/g4p/G4CPT/work/root/sprof/cpu_summary_${xver1}_${xapp}.data
CPU_SUMMARY_2=/work1/g4p/g4p/G4CPT/work/root/sprof/cpu_summary_${xver2}_${xapp}.data

# --> migrate --> OUT_DIR=/g4/g4p/work/root/sprof
# --> migrate again --> OUT_DIR=/lfstev/g4p/g4p/work/root/sprof
#
# --> Jan.2021 migration to WC-IC
#
OUT_DIR=/work1/g4p/g4p/G4CPT/work/root/sprof
#
